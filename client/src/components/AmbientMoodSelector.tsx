      ...
      <Popover>
        <PopoverTrigger asChild>
          <Button
            variant="outline"
            size="sm"
            className={`bg-black/90 backdrop-blur-lg px-3 py-2 text-xs md:text-sm transition-all duration-300 ${
              selectedMood.id === 'templo' ? 'border-gray-500/30 text-gray-300 hover:bg-gray-500/10' :
              selectedMood.id === 'umbral' ? 'border-purple-500/30 text-purple-300 hover:bg-purple-500/10' :
              selectedMood.id === 'chamas' ? 'border-red-500/30 text-red-300 hover:bg-red-500/10' :
              selectedMood.id === 'lua-negra' ? 'border-slate-500/30 text-slate-300 hover:bg-slate-500/10' :
              selectedMood.id === 'void-cosmico' ? 'border-violet-500/30 text-violet-300 hover:bg-violet-500/10' :
              selectedMood.id === 'trono-luciferiano' ? 'border-yellow-500/30 text-yellow-300 hover:bg-yellow-500/10' :
