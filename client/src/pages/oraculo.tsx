...
export default function Oraculo() {
  ...
  const [userCredits, setUserCredits] = useState(10); // Default T'KAZH credits
  ...
  const handleConsultation = async () => {
    ...
    // Check if user has enough T'KAZH credits
    ...
    // Simulate oracle consultation with specific readings
    setTimeout(() => {
