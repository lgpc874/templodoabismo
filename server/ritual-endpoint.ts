...
// Standalone ritual consultation endpoint
app.post('/api/oracle/ritual-consult', async (req: any, res: Response) => {
  try {
    const { question, oracleType, entityName } = req.body;
    
    console.log('Ritual consultation request:', { question, oracleType, entityName });
    ...
    console.log('Sending ritual consultation response for entity:', entityName);
