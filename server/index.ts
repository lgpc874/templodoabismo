...
(async () => {
  // Oracle ritual consultation with entities - PRIORITY REGISTRATION
  app.post('/api/oracle/ritual-consult', async (req: any, res: Response) => {
    try {
      console.log('=== RITUAL CONSULTATION REQUEST ===');
      ...
      // Entity responses with authentic mystical content
      const entityResponses = {
        ...
        'Speculum': {
          ...
          farewell: 'The mirror's surface grows dark as Speculum retreats into the realm of infinite reflections...'
        },
        'Runicus': {
      ...
      console.log(`Ritual consultation completed for ${entityName}`);
